...
void Svgfile::addRectangle(double x, double y, double L, double l, std::string colorFill)
{
    m_ostrm << "<polygon points=\" "
            << x << "," << y << " "
            << x+L << "," << y << " "
...
void Svgfile::addPallelepipede(const Coords c1, const Coords c2, const Coords c3, const Coords c4, std::string colorFill)
{
    m_ostrm << "<polygon points=\" "
            << c1.getX() << "," << c1.getY() << " "
            << c2.getX() << "," << c2.getY() << " "
...
void Svgfile::addLine(Coords c1,Coords c2,std::string color)
{
    addLine(c1.getX(),c1.getY(),c2.getX(),c2.getY(),color);
}
